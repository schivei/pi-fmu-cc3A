...
public class Paciente extends javax.swing.JInternalFrame {
  ...
  private void initComponents() {
    ...
    jComboBox1.setModel(new DefaultComboBoxModel<>(TipoPessoa.values()));

    jLabel3.setText("Nome do Usuário");

    jLabel4.setText("Sexo");

    jComboBox2.setModel(new DefaultComboBoxModel<>(Genero.values()));
    ...
    jLabel12.setText("Descrição/Observação");

    jLabel13.setText("Tipo de Usuário");

    jButton1.setText("Salvar");

    jComboBox3.setModel(new DefaultComboBoxModel<>(TipoUsuario.values()));
